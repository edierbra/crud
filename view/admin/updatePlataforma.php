...
$id_plataforma = $_GET['id_plataforma_pk'];
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-4 col-md-offset-4">
                <div class="mt-3"></div>
                <form id="formulario_updateplataforma">
                    <fieldset>
                        <legend class="text-center text-bold" style="font-size: 30px;">Editar Plataforma: <?php echo $nombre ?></legend>

                        <label class="sr-only" for="categoria">Plataforma</label>
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-tag fixed-width-icon"></i></div>
                            <input type="text" value="<?php echo $nombre ?>" class="form-control" id="plataforma" name="plataforma" placeholder="Ingresa el nombre de la plataforma" oninput="validarCampo(this)">
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" value="<?php echo $id_plataforma ?>" class="form-control" id="id" name="id" readonly>
                        </div>
