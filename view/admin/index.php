  ...
  <div>
    <body class="text-center">
      ...
      ?>
              <tr>
                ...
                <td>
                  <a href="edit.php?id_videojuego_pk=<?php echo $row['id_videojuego_pk'] ?>" class="btn btn-secondary">
                    <i class="fas fa-marker"></i> <img src="../../img/editar.png" alt="Editar" width="50px">
                  </a>
                  <a href="delete_task.php?id_videojuego_pk=<?php echo $row['id_videojuego_pk'] ?>" class="btn btn-secondary">
                    <i class="far fa-trash-alt"></i> <img src="../../img/eliminar.jpeg" alt="Eliminar" width="50px">
                  </a>
                </td>
              </tr>
            <?php
            ...
            <p>
                No tienes videojuegos? <a href="./agregarjuegos.php"> Agregar Juegos!</a>
              </p>
          <?php
        }
