      ...
      <form id="searchForm" class="form-inline" style="display: inline-flex;">
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" id="search" name="search" class="form-control input-lg" placeholder="Ingrese el nombre de la plataforma a buscar">
          </div>
        </div>
      </form>

      <a href="createPlataforma.php" class="btn btn-primary" style="display: inline-flex; align-items: center;">
        Añadir Plataforma
